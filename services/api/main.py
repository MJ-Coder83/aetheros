...
# ---------------------------------------------------------------------------
# Intelligence Profile endpoints
# ---------------------------------------------------------------------------


def _get_intelligence_profile_service() -> IntelligenceProfileEngine:
    return IntelligenceProfileEngine(tape_service=_get_tape_service())


IntelligenceProfileServiceDep = Annotated[
    IntelligenceProfileEngine, Depends(_get_intelligence_profile_service)
]
...
@app.post("/profiles/interactions")
...
@app.get("/profiles/{user_id}/preferences/{category}")
...
@app.post("/profiles/{user_id}/snapshots")
...
@app.get("/profiles/{user_id}/snapshots")
...
@app.post("/profiles/{user_id}/rollback/{snapshot_id}")
...
@app.get("/profiles/{user_id}/domains")
...
@app.get("/profiles/{user_id}/context")
...
@app.post("/profiles/{user_id}/archive")
...
@app.post("/profiles/{user_id}/suspend")
...
@app.post("/profiles/{user_id}/reactivate")
